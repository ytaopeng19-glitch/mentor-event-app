...
st.markdown("""
欢迎报名参加本次活动！[cite: 1, 4]
* **活动时间**：2026年3月29日 19:00 - 21:00 [cite: 6]
* **活动地点**：西教学楼3-104 [cite: 7]
* **特邀企业**：瑞丰公司 [cite: 9]
* **面向对象**：学院各年级有求职需求的学生 [cite: 10]
""")
...
with st.form("registration_form"):
    ...
    research_direction = st.text_input("研究方向（硕博生必填）", placeholder="如：土壤磷素转化、食用菌栽培、纳米材料等")
